package mine.core.ssh.dao.impl;

import java.io.Serializable;
import java.util.Collection;
import java.util.List;

import mine.core.ssh.dao.IHibernateDAO;
...
public class HibernateDAOImpl extends HibernateDaoSupport implements IHibernateDAO{
	 ...
	 * @see Session.get(java.lang.String, java.io.Serializable)
	 */
	@Override
	 ...
	 * @return a persistent instance or null 
	 * @see Session.get(java.lang.String, java.io.Serializable, org.hibernate.LockMode)
	 */
	@Override
	 ...
	 * @param lockMode - the lock mode
	 * @return a persistent instance or null
	 * @see Session.get(Class, java.io.Serializable, org.hibernate.LockMode)
	 */
	@Override
	 ...
	 * @param id - an identifier
	 * @see Session.load(Object, java.io.Serializable)
	 */
	@Override
